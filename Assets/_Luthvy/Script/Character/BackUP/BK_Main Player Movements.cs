...
public class BK_MainPlayerMovements : MonoBehaviour
{
/// ///////////////////////////////////////////////////////
/// PLAYER BIT
...
/// START
    void Start()
    {
        ...
        if (inputSource == null)
        {
            Debug.LogError("PlayerInput source is NULL on " + gameObject.name);
            return;
        }

        inputAsset = inputSource.actions;
